...
const albums = [
    ...
    },
    {
        ...
        criteria: [criteria.ROCK, criteria.JAM, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: `Searchin'`,
        selectedTrackYtId: "Yb6dBr9GbCY",
        spotifyId: "5jLsadddy5Mrw0OWh0rpar",
        deezerId: "14787733",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        year: 1972,
        country: regions.NORWAY,
        criteria: [criteria.ROCK, criteria.JAM, criteria.UNCOMMON_INSTRUMENTS, criteria.C_FOLK],
        selectedTrackTitle: `Sea Wolf`,
        selectedTrackYtId: "dj3nnglcjE0",
        spotifyId: "5vxZm9QdzBB0KjAFLdW4Zo",
        deezerId: "14838021",
    ...
    {
        id: "titanic_eagle_rock",
        title: "Eagle Rock",
        artist: "Titanic",
        year: 1973,
        country: regions.NORWAY,
        criteria: [criteria.HEAVY, criteria.JAM, criteria.SOUND_COLLAGES, criteria.SPECTACULAR],
        selectedTrackTitle: `Dying Sun`,
        selectedTrackYtId: "HLFBTgWFD6o",
        spotifyId: "5KMXdXkAeiAjkJUJfEORj5",
        deezerId: "14838227",
        designers: ["Gérard Targowla"],
        similarAlbums: ["uriah_heep_demons_and_wizards"],
        isAGem: true,
    },
    {
        id: "titanic_ballad_of_a_rock_n_roll_loser",
        title: "Ballad Of A Rock 'N' Roll Loser",
        artist: "Titanic",
        year: 1975,
        country: regions.NORWAY,
        criteria: [criteria.ROCK, criteria.FEMALE, criteria.PIANO, criteria.C_FOLK],
        selectedTrackTitle: `Don't Turn Around`,
        selectedTrackYtId: "DDGRloRrYSo",
        spotifyId: "16Qdfa54cu3tX900AVcG3a",
        deezerId: "14838245",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "trevor_mc_namara_yeah_captain",
        title: "Yeah Captain",
        artist: "Trevor McNamara",
        year: 1971,
        country: regions.AUSTRALIA,
        criteria: [criteria.ROCK, criteria.C_FOLK, criteria.C_PSYCHE, criteria.PATCHWORK, criteria.GREASY_SEVENTIES],
        selectedTrackTitle: `Silver`,
        selectedTrackYtId: "sGMIO4h7XMY",
        spotifyId: null,
        deezerId: null,
        designers: ["Trevor McNamara"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "troya_point_of_eruption",
        title: "Point Of Eruption",
        artist: "Troya",
        year: 1976,
        country: regions.GERMANY,
        criteria: [criteria.SYMPHONIC, criteria.HUMBLE, criteria.JAM, criteria.INSTRUMENTAL],
        selectedTrackTitle: "Battle Rock",
        selectedTrackYtId: "EMo-iueKSKA",
        spotifyId: null,
        deezerId: null,
