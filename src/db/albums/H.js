...
const albums = [
    ...
    {
        id: "happy_the_man_better_late",
        title: `"Better late..."`,
        artist: "Happy The Man",
        year: 1983,
        country: regions.USA,
        criteria: [criteria.INSTRUMENTAL, criteria.GLITTER, criteria.SOFT, criteria.C_JAZZ, criteria.C_ELECTRO, criteria.JAZZY_GROOVY],
        selectedTrackTitle: "Labyrinth",
    ...
    {
        id: "harsh_reality_heaven_and_hell",
        title: "Heaven & Hell",
        artist: "Harsh Reality",
        year: 1969,
        country: regions.WALES,
        criteria: [criteria.ROCK, criteria.JAM, criteria.BLUESY, criteria.CRISPY_SIXTIES, criteria.FEMALE, criteria.C_PSYCHE],
        selectedTrackTitle: `Devil's Daughter`,
        selectedTrackYtId: "7XVPV97c_jE",
        spotifyId: null,
        deezerId: null,
    ...
    {
        id: "headband_a_song_for_tooley",
        title: "A Song For Tooley",
        artist: "Headband",
        year: 1973,
        country: regions.AUSTRALIA,
        criteria: [criteria.C_PSYCHE, criteria.GREASY_SEVENTIES, criteria.ROCK],
        selectedTrackTitle: "Goodbye Mother Nature",
        selectedTrackYtId: "tUey9IBHkpM",
        spotifyId: "4Eq7WcccmL1rbKAqGuvdI0",
        deezerId: "110433182",
        designers: ["Vytas Serelis"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "henry_tree_electric_holy_man",
        title: "Electric Holy Man",
        artist: "Henry Tree",
        year: 1969,
        country: regions.USA,
        criteria: [criteria.ROCK, criteria.C_FOLK, criteria.C_PSYCHE, criteria.CRISPY_SIXTIES],
        selectedTrackTitle: "Electric Holy Man",
        selectedTrackYtId: "mPJGQLVJj58",
        spotifyId: "3rCSkw62rcqwdIjemMKomB",
        deezerId: "387979",
        designers: ["Izzy Sanabria"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "hokus_poke_earth_harmony",
        title: "Earth Harmony",
        artist: "Hokus Poke",
        year: 1972,
        country: regions.ENGLAND,
        criteria: [criteria.ROCK, criteria.C_FOLK],
        selectedTrackTitle: "Sunrise Sunset",
        selectedTrackYtId: "chokvQaj7E0",
        spotifyId: "25SsepK1wad5bOg8e4RNs5",
        deezerId: "12565448",
    ...
    {
        id: "hot_flash_first_attack_theyll_never_take_us_alive",
        title: "First Attack! They'll Never Take Us Alive",
        artist: "Hot FLash",
        year: 1977,
        country: regions.USA,
        criteria: [criteria.C_ELECTRO, criteria.GLITTER, criteria.ROCK_OPERA, criteria.SPECTACULAR],
        selectedTrackTitle: "They'll Never Take Us Alive",
        selectedTrackYtId: "K6siR-2783k",
        spotifyId: null,
        deezerId: null,
        designers: ["Hot FLash", "Bob Eastman", "Bill Macek"],
        similarAlbums: [],
        isAGem: false,
    },
    {
