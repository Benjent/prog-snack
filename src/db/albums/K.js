...
const albums = [
    ...
    {
        id: "kayvas_jute_wide_open",
        title: "Wide Open",
        artist: "Kahvas Jute",
        year: 1971,
        country: regions.AUSTRALIA,
        criteria: [criteria.ROCK, criteria.C_PSYCHE, criteria.GREASY_SEVENTIES],
        selectedTrackTitle: "Up There",
        selectedTrackYtId: "W13OVu3MnHQ",
        spotifyId: "50QeVEuOMDxvNOMgEC8wUn",
        deezerId: "366719",
        designers: ["Robby Harris"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "the_kinks_face_to_face",
        title: "Face To Face",
        artist: "The Kinks",
        year: 1966,
        country: regions.ENGLAND,
        criteria: [criteria.ART_POP, criteria.C_FOLK, criteria.BAROQUE],
        selectedTrackTitle: "Rosie Won't You Please Come Home",
        selectedTrackYtId: "nnXjxtfKFDM",
        spotifyId: null,
        deezerId: "352731007",
        designers: [],
        similarAlbums: [],
    ...
    {
        id: "the_kinks_something_else_by_the_kinks",
        title: "Something Else By The Kinks",
        artist: "The Kinks",
        year: 1967,
        country: regions.ENGLAND,
        criteria: [criteria.ART_POP, criteria.C_FOLK, criteria.BAROQUE],
        selectedTrackTitle: "Lazy Old Sun",
        selectedTrackYtId: "nnXjxtfKFDM",
        spotifyId: null,
        deezerId: "352735987",
        designers: [],
    ...
    {
        id: "the_kinks_the_kinks_are_the_village_green_preservation_society",
        title: "The Kinks Are The Village Green Preservation Society",
        artist: "The Kinks",
        year: 1968,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.ART_POP, criteria.C_PSYCHE, criteria.BAROQUE],
        selectedTrackTitle: "Last Of The Steam-Powered Trains",
        selectedTrackYtId: "mtfoJ8pPE5c",
        spotifyId: "0YgkR96bK9JSHcj236W9ZK",
        deezerId: "76396632",
        designers: ["Bob Lawrie"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "the_kinks_arthur_or_the_decline_and_fall_of_the_british_empire",
        title: "Arthur Or The Decline And Fall Of The British Empire",
        artist: "The Kinks",
        year: 1969,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.FANFARE, criteria.C_PSYCHE, criteria.BAROQUE, criteria.ART_POP],
        selectedTrackTitle: "Nothing To Say",
        selectedTrackYtId: "cl55uZgLnII",
        spotifyId: "5p5sFNiicCu5Ofrw1vaSz7",
        deezerId: "351944387",
        designers: ["Bob Lawrie"],
    ...
    {
        id: "the_kinks_lola_versus_powerman_and_the_moneygoround",
        title: "Lola Versus Powerman And The Moneygoround",
        artist: "The Kinks",
        year: 1970,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.ART_POP, criteria.C_FOLK, criteria.SOUND_COLLAGES],
        selectedTrackTitle: "Get Back In Line",
        selectedTrackYtId: "mCzKqM567Ek",
        spotifyId: "70kpGi2o0I7NY4DfwIN2p0",
        deezerId: "352735377",
        designers: ["Pye Records Studios"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        year: 1971,
        country: regions.ENGLAND,
        criteria: [criteria.BLENDS, criteria.SOUNDTRACK, criteria.UNCOMMON_INSTRUMENTS, criteria.BAROQUE],
        selectedTrackTitle: "The Way Love Used To Be",
        selectedTrackYtId: "kk_s-CjTi2g",
        spotifyId: "4dA6LvPHNtQ02yMfTEGcuh",
        deezerId: "352731547",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "the_kinks_everybodys_in_showbiz",
        title: "Everybody's In Show-Biz",
        artist: "The Kinks",
        year: 1972,
        country: regions.ENGLAND,
        criteria: [criteria.ART_POP, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "Unreal Reality",
        selectedTrackYtId: "3_aW5rZ_aYo",
        spotifyId: "1q8qPRzFAhUAzfPld79guo",
        deezerId: "352734897",
        designers: [],
        similarAlbums: [], // similar bowie ziggy
        isAGem: false,
    },
    {
        id: "the_kinks_preservation_act_1",
        title: "Preservation Act 1",
        artist: "The Kinks",
        year: 1973,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.ROCK_OPERA, criteria.FUNNY, criteria.FANFARE, criteria.FEMALE, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "There's A Change In The Weather",
        selectedTrackYtId: "4lui8xS2myw",
        spotifyId: "11v5JY4aw8gOtKO7y9X6ne",
        deezerId: "352913577",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "the_kinks_preservation_act_2",
        title: "Preservation Act 2",
        artist: "The Kinks",
        year: 1974,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.ROCK_OPERA, criteria.FUNNY, criteria.FANFARE, criteria.FEMALE, criteria.UNCOMMON_INSTRUMENTS, criteria.C_PSYCHE],
        selectedTrackTitle: "When A Solution Comes",
        selectedTrackYtId: "5p8DV5Sd0SA",
        spotifyId: "0dNfAJq1lzUjqOpzEvWe0z",
        deezerId: "173451462",
        designers: ["Bob Searles", "Jerry Preston"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "the_kinks_soap_opera",
        title: "Soap Opera",
        artist: "The Kinks",
        year: 1975,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.ROCK_OPERA, criteria.FEMALE, criteria.BLENDS, criteria.FANFARE],
        selectedTrackTitle: "You Make It All Worthwhile",
        selectedTrackYtId: "LkDrkZDHo9I",
        spotifyId: "3K0mHlFNmCdSzy20hEmkje",
        deezerId: "173480162",
    ...
    {
        id: "the_kinks_schoolboys_in_disgrace",
        title: "Schoolboys In Disgrace",
        artist: "The Kinks",
        year: 1975,
        country: regions.ENGLAND,
        criteria: [criteria.CONCEPT, criteria.PIANO, criteria.FEMALE, criteria.ROCK],
        selectedTrackTitle: "Education",
        selectedTrackYtId: "XPWZym4mA6E",
        spotifyId: "6q0HXf594eGXeqwRjACjba",
        deezerId: "173455452",
        designers: ["Mickey Finn"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "kraftwerk_kraftwerk",
        title: "Kraftwerk",
        artist: "Kraftwerk",
        year: 1970,
        country: regions.GERMANY,
        criteria: [criteria.LENGTHY_TRACKS, criteria.INSTRUMENTAL, criteria.EXPERIMENTAL, criteria.SPACY, criteria.SOUND_COLLAGES, criteria.C_ELECTRO],
        selectedTrackTitle: `Ruckzuck`,
        selectedTrackYtId: "tWKfo3LDI1Q",
        spotifyId: null,
        deezerId: null,
        designers: ["Ralf Hütter"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "kraftwerk_kraftwerk_2",
        title: "Kraftwerk",
        artist: "Kraftwerk 2",
        year: 1972,
        country: regions.GERMANY,
        criteria: [criteria.LENGTHY_TRACKS, criteria.INSTRUMENTAL, criteria.EXPERIMENTAL, criteria.UNCOMMON_INSTRUMENTS, criteria.C_ELECTRO],
        selectedTrackTitle: `Klingklang`,
        selectedTrackYtId: "MXnjC3w6v60",
        spotifyId: null,
        deezerId: null,
        designers: ["Ralf Hütter", "Florian Schneider"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "kraftwerk_ralf_und_florian",
        title: "Kraftwerk",
        artist: "Ralf & Florian",
        year: 1973,
        country: regions.GERMANY,
        criteria: [criteria.LENGTHY_TRACKS, criteria.ELECTRO, criteria.INSTRUMENTAL, criteria.AMBIENT, criteria.SOFT],
        selectedTrackTitle: `Ananas Symphonie`,
        selectedTrackYtId: "CJuq4VphINw",
        spotifyId: null,
        deezerId: null,
        designers: ["Ralf Hütter", "Florian Schneider", "Emil Schult"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "kraftwerk_autobahn",
        title: "Kraftwerk",
        artist: "Autobahn",
        year: 1974,
        country: regions.GERMANY,
        criteria: [criteria.LENGTHY_TRACKS, criteria.ELECTRO, criteria.C_PSYCHE, criteria.INSTRUMENTAL, criteria.SOFT, criteria.GERMAN],
        selectedTrackTitle: `Autobahn`,
        selectedTrackYtId: "vkOZNJYAZ7c",
        spotifyId: "0DzC0tyowMi2O9QfkDRvfJ",
        deezerId: "396599",
        designers: ["Emil Schult"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "kraftwerk_radioaktivitat",
        title: "Kraftwerk",
        artist: "Radio-Aktivität",
        year: 1975,
        country: regions.GERMANY,
        criteria: [criteria.TRANSITION, criteria.ELECTRO, criteria.C_PSYCHE, criteria.CONCEPT, criteria.GERMAN],
        selectedTrackTitle: `Radioaktivität`,
        selectedTrackYtId: "X--F5b5IdqU",
        spotifyId: null,
        deezerId: null,
        designers: ["Emil Schult"],
        similarAlbums: [],
    ...
    {
        id: "kraftwerk_trans_europa_express",
        title: "Kraftwerk",
        artist: "Trans Europa Express",
        year: 1977,
        country: regions.GERMANY,
        criteria: [criteria.ELECTRO, criteria.INSTRUMENTAL, criteria.TRANSITION, criteria.GERMAN],
        selectedTrackTitle: `Europa Endlos`,
        selectedTrackYtId: "P5ZYy7gNTMQ",
        spotifyId: "3eB8X3S4gPMQHiLdmxvvhg",
        deezerId: "1234216",
        designers: ["Emil Schult", "Maurice Seymour"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "kraftwerk_die_menshmaschine",
        title: "Kraftwerk",
        artist: "Die Mensch-Maschine",
        year: 1978,
        country: regions.GERMANY,
        criteria: [criteria.ELECTRO, criteria.SCI_FI, criteria.HUMBLE, criteria.GERMAN, criteria.SOFT],
        selectedTrackTitle: `Spacelab`,
        selectedTrackYtId: "nZXYnVBK0fY",
        spotifyId: "7uywQiWxD6krusHiYqujtF",
        deezerId: "1234217",
        designers: ["Günter Fröhling", "Karl Klefisch"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "kraftwerk_computerwelt",
        title: "Kraftwerk",
        artist: "Computerwelt",
        year: 1981,
        country: regions.GERMANY,
        criteria: [criteria.ELECTRO, criteria.HUMBLE, criteria.GERMAN, criteria.SOFT],
        selectedTrackTitle: `Computerwelt`,
        selectedTrackYtId: "YxlndeU3SVY",
        spotifyId: "2ZYLme9VXn1Eo8JDtfN7Y9",
        deezerId: "1234218",
        designers: ["Carol Martin"],
        similarAlbums: [],
        isAGem: false,
    },
    {
