...
const albums = [
    ...
    {
        id: "diaouled_ar_menez_diaouled_ar_menez",
        title: "Diaouled Ar Menez",
        artist: "Diaouled Ar Menez",
        year: 1973,
        country: regions.FRANCE,
        criteria: [criteria.FOLK, criteria.ODD_RHYTHM, criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.MEDIEVAL, criteria.BRETON],
        selectedTrackTitle: "Étienne Riwallan",
        selectedTrackYtId: "gI7E_f6WbVE",
        spotifyId: "38phoyoIv6mTjQyHiC4zYw",
        deezerId: "46183072",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "diaouled_ar_menez_atav_ez_eomp",
        title: "Atav Ez Eomp",
        artist: "Diaouled Ar Menez",
        year: 1977,
        country: regions.FRANCE,
        criteria: [criteria.FOLK, criteria.ODD_RHYTHM, criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.MEDIEVAL],
        selectedTrackTitle: "Bale Kolloreg",
        selectedTrackYtId: "qzTTv3xyPRU",
        spotifyId: null,
        deezerId: null,
        designers: [],
        similarAlbums: [],
    ...
    {
        id: "diaouled_ar_menez_merch_an_diaoul",
        title: "Merc'h An Diaoul",
        artist: "Diaouled Ar Menez",
        year: 1987,
        country: regions.FRANCE,
        criteria: [criteria.C_FOLK, criteria.ODD_RHYTHM, criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.MEDIEVAL, criteria.FRENCH, criteria.C_ELECTRO],
        selectedTrackTitle: "Vol De Menhirs",
        selectedTrackYtId: "p9ig5W7Gcqk",
        spotifyId: null,
        deezerId: null,
    ...
    },
    {
        ...
        year: 1974,
        country: regions.DENMARK,
        criteria: [criteria.ODD_RHYTHM, criteria.JAM, criteria.UNCOMMON_INSTRUMENTS, criteria.C_PSYCHE, criteria.C_JAZZ, criteria.FUNNY, criteria.JAZZY_GROOVY, criteria.FEMALE, criteria.FANFARE, criteria.FRENCH],
