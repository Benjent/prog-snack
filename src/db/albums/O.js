...
const albums = [
    ...
    },
    {
        ...
        year: 1981,
        country: regions.HUNGARY,
        criteria: [criteria.HUNGARIAN, criteria.C_ELECTRO, criteria.NEO_EIGHTIES, criteria.ROCK, criteria.ARENA],
        selectedTrackTitle: "A Fehér Holló",
        selectedTrackYtId: "y9juwoZxSX8",
        spotifyId: null,
        deezerId: null,
        designers: ["Nyári István"],
        similarAlbums: [],
    ...
    },
    {
        ...
        year: 1982,
        country: regions.HUNGARY,
        criteria: [criteria.HUNGARIAN, criteria.ELECTRO, criteria.NEO_EIGHTIES],
        selectedTrackTitle: "Alvajáró",
        selectedTrackYtId: "GQ9aAXI49uI",
        spotifyId: null,
        deezerId: null,
        designers: [],
        similarAlbums: [], // similar kraftwerk
        isAGem: false,
    },
    {
    ...
    },
    {
        ...
        year: 1979,
        country: regions.FRANCE,
        criteria: [criteria.FRENCH, criteria.LENGTHY_TRACKS, criteria.SYMPHONIC, criteria.C_PSYCHE, criteria.C_ELECTRO, criteria.CONCEPT, criteria.ROCK_OPERA, criteria.FEMALE],
        selectedTrackTitle: "Schizologues",
        selectedTrackYtId: null,
        spotifyId: null,
        deezerId: null,
        designers: ["Alain Ranou"],
        similarAlbums: ["arachnoid_arachnoid", "ange_guet_apens"],
        isAGem: false,
    },
    {
