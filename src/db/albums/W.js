...
const albums = [
    ...
    {
        id: "war_all_day_music",
        title: "All Day Music",
        artist: "War",
        year: 1971,
        country: regions.USA,
        criteria: [criteria.LATINO, criteria.JAZZY_GROOVY, criteria.C_PSYCHE, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "All Day Music",
        selectedTrackYtId: "coHUt4si8Oo",
        spotifyId: "1XHgFYxf1sZeBGfgbJB3ai",
        deezerId: "15484154",
        designers: ["Lee Oskar"],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "war_the_world_is_a_ghetto",
        title: "The World Is A Ghetto",
        artist: "War",
        year: 1972,
        country: regions.USA,
        criteria: [criteria.LENGTHY_TRACKS, criteria.JAZZY_GROOVY, criteria.JAM, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "City, Country, City",
        selectedTrackYtId: "DZmeFGmiQDI",
        spotifyId: "4UZmpGH8kpAgyZ2yqQ8sP9",
        deezerId: "15484166",
        designers: ["Howard Miller"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "war_deliver_the_word",
        title: "Deliver The Word",
        artist: "War",
        year: 1973,
        country: regions.USA,
        criteria: [criteria.C_PSYCHE, criteria.JAZZY_GROOVY, criteria.JAM, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "H2 Overture",
        selectedTrackYtId: "TViT_KFVWgI",
        spotifyId: "4mVKP4QgluQEiyVqEekwy3",
        deezerId: "15484158",
        designers: ["Garry Sato"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "war_why_cant_we_be_friends",
        title: "Why Can't We Be Friends?",
        artist: "War",
        year: 1975,
        country: regions.USA,
        criteria: [criteria.ART_POP, criteria.LATINO, criteria.JAZZY_GROOVY, criteria.UNCOMMON_INSTRUMENTS, criteria.TOUCHING_VOCALS],
        selectedTrackTitle: "Lotus Blossom",
        selectedTrackYtId: "HfmxxkFxyqA",
        spotifyId: "59euB5Ns7yGbS06OYHwxRN",
        deezerId: "15484194",
        designers: ["Howard Miller"],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "wild_man_fischer_an_evening_with_wild_man_fischer",
        title: "An Evening With Wild Man Fischer",
        artist: "Wild Man Fischer",
        year: 1969,
        country: regions.USA,
        criteria: [criteria.FUNNY, criteria.EXPERIMENTAL, criteria.UNCOMMON_INSTRUMENTS, criteria.PATCHWORK, criteria.SOUND_COLLAGES],
        selectedTrackTitle: `The Madness & Ecstasy`,
        selectedTrackYtId: "7PLZnqsAT6w",
        spotifyId: "5ZhMcnsYTCQ0co2wioTfng",
        deezerId: null,
        designers: [],
        similarAlbums: ["gtos_permanent_damage"],
        isAGem: false,
    },
    {
    ...
    {
        id: "wizzards_convention_wizzards_convention",
        title: "Wizard's Convention",
        artist: "Wizard's Convention",
        year: 1976,
        country: regions.ENGLAND,
        criteria: [criteria.ROCK, criteria.JAZZY_GROOVY, criteria.PIANO],
        selectedTrackTitle: "Until Tomorrow",
        selectedTrackYtId: "jrDEiKTVU1Y",
        spotifyId: "3MwUcpg8hUuaOvEFHQNVbc",
        deezerId: null,
        designers: [],
