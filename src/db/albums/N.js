...
const albums = [
    ...
    {
        id: "national_head_band_albert_1",
        title: "Albert 1",
        artist: "National Head Band",
        year: 1971,
        country: regions.ENGLAND,
        criteria: [criteria.ROCK, criteria.BLUESY, criteria.JAM, criteria.C_ELECTRO],
        selectedTrackTitle: "Mister Jesus",
        selectedTrackYtId: "eHkPI6lPbfQ",
        spotifyId: "2n5NfP8cohOElBzAbJfOkj",
        deezerId: null,
        designers: ["Ginny Gillam"],
        similarAlbums: [],
        isAGem: false,
    },
    {
