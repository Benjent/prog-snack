...
const albums = [
    ...
    {
        id: "ekseption_beggar_julias_time_trip",
        title: "Beggar Julia's Time Trip",
        artist: "Ekseption",
        year: 1970,
        country: regions.NETHERLANDS,
        criteria: [criteria.CONCEPT, criteria.FEMALE, criteria.PATCHWORK, criteria.INSTRUMENTAL, criteria.BAROQUE, criteria.FANFARE, criteria.ODD_RHYTHM, criteria.PIANO, criteria.TRANSITION, criteria.C_PSYCHE, criteria.ORCHESTRAL_PARTS, criteria.C_JAZZ, criteria.SYMPHONIC],
        selectedTrackTitle: "Ouverture",
        selectedTrackYtId: "mo4BTHT46lU",
        spotifyId: "2fIz9d7g2bxNXW9nPadWby",
        deezerId: "629336",
        designers: ["Jan Van Toorn"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "ekseption_ekseption_3",
        title: "Ekseption 3",
        artist: "Ekseption",
        year: 1970,
        country: regions.NETHERLANDS,
        criteria: [criteria.BAROQUE, criteria.FANFARE, criteria.UNCOMMON_INSTRUMENTS, criteria.SPECTACULAR, criteria.SYMPHONIC],
        selectedTrackTitle: "Piece For Symphonic And Rockgroup In A Minor",
        selectedTrackYtId: "w1-8eOL4ycY",
        spotifyId: "3dEsHNpYJakU9X1OQUZoYT",
        deezerId: "6297059",
        designers: ["Niko Spring in 't Veld"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        year: 1971,
        country: regions.NETHERLANDS,
        criteria: [criteria.BAROQUE, criteria.FANFARE, criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.JAM, criteria.JAZZY_GROOVY, criteria.SYMPHONIC, criteria.LENGTHY_TRACKS, criteria.C_JAZZ, criteria.C_PSYCHE, criteria.C_ELECTRO, criteria.ORCHESTRAL_PARTS],
        selectedTrackTitle: "Body Party",
        selectedTrackYtId: "KhLb-WBKRqo",
        spotifyId: null,
        deezerId: null,
        designers: [],
        similarAlbums: [],
    ...
    {
        id: "ekseption_ekseption_5",
        title: "Ekseption 5",
        artist: "Ekseption",
        year: 1972,
        country: regions.NETHERLANDS,
        criteria: [criteria.BAROQUE, criteria.FANFARE, criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.JAM, criteria.JAZZY_GROOVY, criteria.SYMPHONIC, criteria.C_JAZZ, criteria.C_ELECTRO, criteria.FEMALE, criteria.TRANSITION],
        selectedTrackTitle: "Midbar Session",
        selectedTrackYtId: "D8Wt4inX8vg",
        spotifyId: "5djng3KHyanAShaM6QVsdM",
        deezerId: "459323785",
        designers: ["Jan Van Uden"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "ekseption_trinity",
        title: "Trinity",
        artist: "Ekseption",
        year: 1973,
        country: regions.NETHERLANDS,
        criteria: [criteria.BAROQUE, criteria.FANFARE, criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.JAM, criteria.SYMPHONIC, criteria.C_ELECTRO, criteria.ODD_RHYTHM],
        selectedTrackTitle: "Improvisation",
        selectedTrackYtId: "BaxEayWYFT8",
        spotifyId: "2yWbFMycJ6tK8dg2NlNWeX",
        deezerId: "485379445",
        designers: ["Jan Van Uden"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        year: 1974,
        country: regions.NETHERLANDS,
        criteria: [criteria.UNCOMMON_INSTRUMENTS, criteria.INSTRUMENTAL, criteria.C_JAZZ, criteria.JAZZY_GROOVY, criteria.BAROQUE],
        selectedTrackTitle: "From Ekseption",
        selectedTrackYtId: "VWBNd2hmxoY",
        spotifyId: "5PTS3xC5LnbjwcCizjMOJZ",
        deezerId: "485379705",
        designers: ["Jan Van Uden"],
        similarAlbums: [],
        isAGem: true,
    ...
    {
        id: "ekseption_mindmirror",
        title: "Mindmirror",
        artist: "Ekseption",
        year: 1975,
        country: regions.NETHERLANDS,
        criteria: [criteria.LENGTHY_TRACKS, criteria.INSTRUMENTAL, criteria.C_JAZZ, criteria.JAZZY_GROOVY, criteria.FANFARE, criteria.BAROQUE, criteria.ODD_RHYTHM, criteria.SYMPHONIC, criteria.C_ELECTRO],
        selectedTrackTitle: "Mindmirror",
        selectedTrackYtId: "l0hNT9KS0Vg",
        spotifyId: "7vS5uLmyodXHFSuMNAe2lu",
        deezerId: "485377045",
        designers: [],
        similarAlbums: [],
        isAGem: true,
    ...
    {
        id: "ekseption_ekseption_78",
        title: "Ekseption '78",
        artist: "Ekseption",
        year: 1978,
        country: regions.NETHERLANDS,
        criteria: [criteria.TRANSITION, criteria.INSTRUMENTAL, criteria.BAROQUE, criteria.C_ELECTRO, criteria.FANFARE, criteria.SYMPHONIC, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "Signal",
        selectedTrackYtId: "FbkToz-Y2Ps",
        spotifyId: "0zFVUbI73bQrYcs1kaBngl",
        deezerId: "8903765",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "emmanuel_booz_le_jour_ou_les_vaches",
        title: "Le Jour Où Les Vaches...",
        artist: "Emmanuel Booz",
        year: 1974,
        country: regions.FRANCE,
        criteria: [criteria.FRENCH, criteria.C_PSYCHE, criteria.FEMALE, criteria.UNCOMMON_INSTRUMENTS, criteria.ROCK_OPERA, criteria.C_ELECTRO, criteria.C_FOLK],
        selectedTrackTitle: "Nous Les Enfants",
        selectedTrackYtId: "cxnbBqrWQ4w",
        spotifyId: "56biJO7S8yOK3eFsFykKr5",
        deezerId: "3334991",
        designers: ["Claude Mallet"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "emmanuel_booz_clochard",
        title: "Clochard",
        artist: "Emmanuel Booz",
        year: 1976,
        country: regions.FRANCE,
        criteria: [criteria.FRENCH, criteria.C_PSYCHE, criteria.C_ELECTRO, criteria.JAM, criteria.C_FOLK],
        selectedTrackTitle: "Un Jour Vous Partirez",
        selectedTrackYtId: "ryrpUxYRTwQ",
        spotifyId: "57T4qI7fbyTr4lus4B83Dc",
        deezerId: "1292347",
        designers: ["Charles Eric"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "emmanuel_booz_dans_quel_etat_jerre",
        title: "Dans Quel État J'erre",
        artist: "Emmanuel Booz",
        year: 1979,
        country: regions.FRANCE,
        criteria: [criteria.FRENCH, criteria.C_ELECTRO, criteria.SYMPHONIC, criteria.SOUND_COLLAGES, criteria.ODD_RHYTHM, criteria.C_PSYCHE, criteria.SPECTACULAR, criteria.TOUCHING_VOCALS],
        selectedTrackTitle: "Ode Aux Rats",
        selectedTrackYtId: "-OIfEDqyGOQ",
        spotifyId: "0EJ3Mo7eQoeJisPswf6tmE",
        deezerId: "1438798",
        designers: ["James Lignier", "Didier Benaouda"],
        similarAlbums: ["ange_guet_apens"],
        isAGem: true,
        description: `TODO Description`,
    },
    {
    ...
    {
        id: "eric_delaunay_antagonisme",
        title: "Antagonisme !",
        artist: "Eric Delaunay",
        year: 1980,
        country: regions.FRANCE,
        criteria: [criteria.ODD_RHYTHM, criteria.INSTRUMENTAL, criteria.C_PSYCHE, criteria.C_ELECTRO],
        selectedTrackTitle: "Antagonisme",
        selectedTrackYtId: "x-SE1WV1b4s",
        spotifyId: null,
        deezerId: null,
        designers: ["Eric Delaunay"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "et_cetera_de_rischkas_soul",
        title: "Rischka's Soul",
        artist: "Et Cetera (DE)",
        year: 1970,
        country: regions.GERMANY,
        criteria: [criteria.C_JAZZ, criteria.JAM, criteria.INSTRUMENTAL, criteria.UNCOMMON_INSTRUMENTS, criteria.C_PSYCHE, criteria.JAZZY_GROOVY],
        selectedTrackTitle: `Reading Machine`,
        selectedTrackYtId: "VSrj_34mcH8",
        spotifyId: null,
        deezerId: null,
        designers: ["Franz Gregor Vogt", "Hartmut Meiser"],
        similarAlbums: [],
        isAGem: false,
    },
    // TODO INTROUVABLE - Rischka's Light Faces
    {
        id: "et_cetera_de_et_cetera",
        title: "Et Cetera",
        artist: "Et Cetera (DE)",
        year: 1971,
        country: regions.GERMANY,
        criteria: [criteria.LENGTHY_TRACKS, criteria.C_JAZZ, criteria.JAM, criteria.INSTRUMENTAL, criteria.UNCOMMON_INSTRUMENTS, criteria.C_PSYCHE, criteria.EXPERIMENTAL, criteria.FEMALE, criteria.C_FOLK],
        selectedTrackTitle: `Raga`,
        selectedTrackYtId: null,
        spotifyId: "7rs1NOeY2op4fP1P6x7CrV",
        deezerId: "392111",
        designers: ["Franz Gregor Vogt", "Hartmut Meiser"],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "et_cetera_de_knirsch",
        title: "Knirsch",
        artist: "Et Cetera (DE)",
        year: 1972,
        country: regions.GERMANY,
        criteria: [criteria.LENGTHY_TRACKS, criteria.C_JAZZ, criteria.JAM, criteria.INSTRUMENTAL, criteria.PIANO, criteria.C_PSYCHE, criteria.C_ELECTRO, criteria.C_JAZZ],
        selectedTrackTitle: `Tuning Spread`,
        selectedTrackYtId: "MGgKmZa1mj8",
        spotifyId: null,
        deezerId: null,
        designers: ["Frieder Grindler"],
        similarAlbums: [],
        isAGem: false,
    },
    ...
    {
        id: "evolution_evolution",
        title: "Evolution",
        artist: "Evolution",
        year: 1970,
        country: regions.SPAIN,
        criteria: [criteria.CRISPY_SIXTIES, criteria.ROCK, criteria.C_PSYCHE],
        selectedTrackTitle: "Water",
        selectedTrackYtId: "56MnPAwDPjI",
        spotifyId: "5nURO7ZSBUR1VErarOSLi4",
        deezerId: null,
        designers: [],
        similarAlbums: [],
        isAGem: false,
