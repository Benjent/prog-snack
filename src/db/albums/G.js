...
const albums = [
    ...
    {
        id: "galadriel_galadriel",
        title: `Galadriel`,
        artist: "Galadriel",
        year: 1971,
        country: regions.AUSTRALIA,
        criteria: [criteria.ROCK, criteria.C_FOLK, criteria.BLUESY, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: `Such A Fool`,
        selectedTrackYtId: "wPjUTIfrw9s",
        spotifyId: "2XPongTCuNGuMySZnW2ndq",
        deezerId: "437176",
        designers: [],
        similarAlbums: ["jethro_tull_aqualung"],
        isAGem: false,
    },
    {
    ...
    {
        id: "gilli_smyth_mother",
        title: `Mother`,
        artist: "Gilli Smyth",
        year: 1978,
        country: regions.ENGLAND,
        criteria: [criteria.FEMALE, criteria.C_PSYCHE, criteria.C_FOLK, criteria.C_ELECTRO, criteria.UNCOMMON_INSTRUMENTS, criteria.SOUND_COLLAGES, criteria.TRANSITION, criteria.SPACY, criteria.FUNNY, criteria.ODD_RHYTHM, criteria.SOCIOPOLITICAL, criteria.FRENCH],
        selectedTrackTitle: "Time Of The Goddess",
        selectedTrackYtId: "h9Xch0cOB-Y",
        spotifyId: "3jKjYlEKZOo202heC2bHHZ",
        deezerId: "93424152",
        designers: ["Jerome Decker", "Daevid Allen"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "giorgio_moroder_einzelganger",
        title: `Einzelgänger`,
        artist: "Giorgio Moroder",
        year: 1975,
        country: regions.GERMANY,
        criteria: [criteria.ELECTRO, criteria.TRANSITION, criteria.C_PSYCHE, criteria.GERMAN],
        selectedTrackTitle: "Aus (The End)",
        selectedTrackYtId: "KV7LHfL8Tjc",
        spotifyId: null,
        deezerId: null,
        designers: [],
        similarAlbums: [],
    ...
    {
        id: "giorgio_moroder_from_here_to_eternity",
        title: `From Here To Eternity`,
        artist: "Giorgio Moroder",
        year: 1977,
        country: regions.GERMANY,
        criteria: [criteria.ELECTRO, criteria.TRANSITION, criteria.NEO_EIGHTIES],
        selectedTrackTitle: "First Hand Experience In Second Hand Love",
        selectedTrackYtId: "EkM7ZBFQPy8",
        spotifyId: "6lE5ickVjJ90hRAFdNCpjv",
        deezerId: null,
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "gong_magick_brother",
        title: "Magic Brother",
        artist: "Gong",
        year: 1970,
        country: regions.FRANCE,
        criteria: [criteria.C_PSYCHE, criteria.FEMALE, criteria.UNCOMMON_INSTRUMENTS, criteria.FRENCH],
        selectedTrackTitle: "Glad To Sad To Say",
        selectedTrackYtId: "8PR1clqkKng",
        spotifyId: "7rxkwwQq3yrfHNWmHGyUX7",
        deezerId: "440538987",
        designers: ["Daevid Allen"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "gongmaison_gongmaison",
        title: "Gongmaison",
        artist: "Gongmaison",
        year: 1989,
        country: regions.ENGLAND,
        criteria: [criteria.FEMALE, criteria.NEO_EIGHTIES, criteria.SPACY, criteria.LENGTHY_TRACKS, criteria.UNCOMMON_INSTRUMENTS, criteria.ORIENTAL, criteria.C_FOLK, criteria.C_ELECTRO, criteria.SYMPHONIC],
        selectedTrackTitle: "Titti-Caca",
        selectedTrackYtId: "thH6nfX4ZwM",
        spotifyId: "6WBzEv9xDiCzp54ojyMTev",
        deezerId: null,
        designers: ["Wandana Turiya"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "good_god_good_god",
        title: "Good God",
        artist: "Good God",
        year: 1972,
        country: regions.USA,
        criteria: [criteria.C_JAZZ, criteria.INSTRUMENTAL, criteria.JAM, criteria.ODD_RHYTHM, criteria.C_PSYCHE],
        selectedTrackTitle: "A Murder Of Crows",
        selectedTrackYtId: "HzlGTuOomOU",
        spotifyId: null,
        deezerId: null,
    ...
    },
    {
        ...
        criteria: [criteria.INSTRUMENTAL, criteria.C_JAZZ, criteria.SOFT_SEVENTIES, criteria.UNCOMMON_INSTRUMENTS, criteria.C_ELECTRO, criteria.ODD_RHYTHM, criteria.SOPHISTICATED],
        selectedTrackTitle: "Historia D'una Gota D'aigua",
        selectedTrackYtId: "IP5kprhBUPI",
        spotifyId: null,
        deezerId: null,
        designers: ["Miguel Angel Machín", "Doroteo Puebla", "Florencio Vázquez"],
        similarAlbums: [],
        isAGem: true,
        description: `TODO Description`,
    },
    ...
    },
    {
        ...
        year: 1979,
        country: regions.FRANCE,
        criteria: [criteria.FRENCH, criteria.GLITTER, criteria.C_PSYCHE, criteria.C_ELECTRO, criteria.UNCOMMON_INSTRUMENTS, criteria.ODD_RHYTHM],
        selectedTrackTitle: "Le Dernier Arbre",
        selectedTrackYtId: "beCMRsulcjs",
        spotifyId: "0k9shB2L75jKCyY4N7WYQj",
        deezerId: "513933",
        designers: ["Thierry Duval"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "the_group_the_group",
        title: "The Group",
        artist: "The Group",
        year: 1978,
        country: regions.FINLAND,
        criteria: [criteria.INSTRUMENTAL, criteria.JAZZY_GROOVY, criteria.SOFT_SEVENTIES],
        selectedTrackTitle: "Gado-Gado",
        selectedTrackYtId: "e8N9NTAp7uo",
        spotifyId: "5g8LoqWnSEzaADqB4GZwOp",
        deezerId: null,
        designers: ["Raz"],
        similarAlbums: [],
        isAGem: true,
    ...
    },
    {
        ...
        artist: "Grupa 220",
        year: 1975,
        country: regions.CROATIA,
        criteria: [criteria.CROATIAN, criteria.ODD_RHYTHM],
        selectedTrackTitle: "Zlatna Vrata",
        selectedTrackYtId: "E83K4gljCJE",
        spotifyId: "2yAv8m7lwG6CuKHF9RCw5d",
        deezerId: null,
        designers: ["Rajko Šimunović", "Ivan Piko Stančić"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "gtos_permanent_damage",
        title: "Permanent Damage",
        artist: " GTO's",
        year: 1969,
        country: regions.USA,
        criteria: [criteria.PATCHWORK, criteria.EXPERIMENTAL, criteria.FUNNY, criteria.FEMALE, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "The Eureka Springs Garbage Lady",
        selectedTrackYtId: "jW7d5IfEz3M",
        spotifyId: null,
        deezerId: null,
        designers: [],
        similarAlbums: [],
    ...
    },
    {
        ...
        year: 1968,
        country: regions.ENGLAND,
        criteria: [criteria.ROCK, criteria.FANFARE, criteria.C_PSYCHE, criteria.GREASY_SEVENTIES, criteria.ORCHESTRAL_PARTS, criteria.HEAVY],
        selectedTrackTitle: "Take Off",
        selectedTrackYtId: "swjrxLWcf74",
        spotifyId: "2OseOkA3vqRP80hY2y4VOw",
        deezerId: "280949341",
        designers: ["Roger Dean"],
        similarAlbums: ["the_crazy_world_of_arthur_brown_the_crazy_world_of_arthur_brown"],
        isAGem: false,
    },
    {
        id: "gun_gun_sight",
        ...
        year: 1969,
        country: regions.ENGLAND,
        criteria: [criteria.ROCK, criteria.C_FOLK, criteria.C_PSYCHE, criteria.GREASY_SEVENTIES, criteria.ORCHESTRAL_PARTS, criteria.HEAVY],
        selectedTrackTitle: "Dreams And Screams",
        selectedTrackYtId: "9LcjN8FyZQo",
        spotifyId: "1C4ZX9fFsRDbfpsZe42H7y",
        deezerId: "274779692",
        designers: ["Hipgnosis"],
        similarAlbums: [],
        isAGem: false,
    ...
    },
    {
        ...
        year: 1970,
        country: regions.GERMANY,
        criteria: [criteria.JAM, criteria.GREASY_SEVENTIES, criteria.INSTRUMENTAL, criteria.C_PSYCHE],
        selectedTrackTitle: "Stone In",
        selectedTrackYtId: "DLne8reoo-Y",
        spotifyId: "7dNrhiN0MYIJCfkriSYj7L",
        deezerId: "181415232",
        designers: ["Iriscop"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        selectedTrackTitle: "Electric Junk",
        selectedTrackYtId: "4trJhvS1SgQ",
        spotifyId: "4Qo61qSta6i0U6ufMtEtv1",
        deezerId: "181415242",
        designers: ["Heinz Dofflein", "Guru Guru"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "guru_guru_kanguru",
        title: "Känguru",
        artist: "Guru Guru",
        year: 1972,
        country: regions.GERMANY,
    ...
    {
        id: "guru_guru_guru_guru",
        title: "Guru Guru",
        artist: "Guru Guru",
        year: 1973,
        country: regions.GERMANY,
        criteria: [criteria.GERMAN, criteria.JAM, criteria.INSTRUMENTAL, criteria.LENGTHY_TRACKS, criteria.BLUESY, criteria.C_PSYCHE],
        selectedTrackTitle: "The Story Of Life",
        selectedTrackYtId: "O5u5BlZxmPg",
        spotifyId: "4Aop4AqDyNYWIaEKdkFATC",
        deezerId: "228348",
        designers: ["Sharon"],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "guru_guru_dont_call_us_we_call_you",
        title: "Don't Call Us (We Call You)",
        artist: "Guru Guru",
        year: 1973,
        country: regions.GERMANY,
        criteria: [criteria.JAM, criteria.LENGTHY_TRACKS, criteria.C_PSYCHE, criteria.ODD_RHYTHM, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "Africa Steals The Show",
        selectedTrackYtId: null,
        spotifyId: null,
        deezerId: null,
        designers: ["Petrus Wandrey"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "guru_guru_dance_of_the_flames",
        title: "Dance Of The Flames",
        artist: "Guru Guru",
        year: 1974,
        country: regions.GERMANY,
        criteria: [criteria.JAM, criteria.ODD_RHYTHM, criteria.INSTRUMENTAL, criteria.C_JAZZ, criteria.UNCOMMON_INSTRUMENTS, criteria.C_FOLK],
        selectedTrackTitle: "God's Endless Love For Men",
        selectedTrackYtId: "kABdEmW7i1Q",
        spotifyId: null,
        deezerId: null,
        designers: [],
        similarAlbums: [], // similar mahavishnu
        isAGem: false, // TODO ALMOST GEM!!!
    },
    {
        id: "guru_guru_mani_und_seine_freunde",
        title: "Mani Und Seine Freunde",
        artist: "Guru Guru",
        year: 1975,
        country: regions.GERMANY,
        criteria: [criteria.JAM, criteria.C_PSYCHE, criteria.C_JAZZ, criteria.JAZZY_GROOVY, criteria.UNCOMMON_INSTRUMENTS, criteria.FUNNY, criteria.SOUND_COLLAGES, criteria.GERMAN],
        selectedTrackTitle: "It's Your Turn",
        selectedTrackYtId: "ll9_X8Prolc",
        spotifyId: null,
        deezerId: null,
        designers: ["Tai Lüdicke"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "guru_guru_tango_fango",
        title: "Tango Fango",
        artist: "Guru Guru",
        year: 1976,
        country: regions.GERMANY,
        criteria: [criteria.GERMAN, criteria.JAZZY_GROOVY, criteria.SOUND_COLLAGES, criteria.C_JAZZ, criteria.JAM, criteria.FUNNY, criteria.C_PSYCHE],
        selectedTrackTitle: "L. Torro",
        selectedTrackYtId: null,
        spotifyId: null,
        deezerId: null,
        designers: ["Tai Lüdicke", "Guru Guru"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        id: "guru_guru_globetrotter",
        title: "Globetrotter",
        artist: "Guru Guru",
        year: 1977,
        country: regions.GERMANY,
        criteria: [criteria.JAZZY_GROOVY, criteria.C_ELECTRO, criteria.C_JAZZ, criteria.JAM, criteria.SOFT_SEVENTIES, criteria.UNCOMMON_INSTRUMENTS, criteria.C_PSYCHE],
        selectedTrackTitle: "Moroso",
        selectedTrackYtId: "M5NI98O8c2s",
        spotifyId: null,
        deezerId: null,
        designers: ["Emanuel Vatter", "Gerd Baumann"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        year: 1979,
        country: regions.GERMANY,
        criteria: [criteria.SOFT_SEVENTIES, criteria.GERMAN, criteria.JAZZY_GROOVY, criteria.JAM, criteria.C_PSYCHE],
        selectedTrackTitle: "Taoma",
        selectedTrackYtId: "YNNRVjwYQZ0",
        spotifyId: "7LJwQVJGsx18wvCeupkqEL",
        deezerId: null,
        designers: ["Wolfgang Gersch"],
        similarAlbums: [],
        isAGem: false,
    },
