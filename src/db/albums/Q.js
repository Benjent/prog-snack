...
const albums = [
    ...
    {
        id: "quatrain_quatrain",
        title: "Quatrain",
        artist: "Quatrain",
        year: 1969,
        country: regions.USA,
        criteria: [criteria.ROCK, criteria.C_PSYCHE],
        selectedTrackTitle: "The Tree",
        selectedTrackYtId: "wnwaZEs6IDU",
        spotifyId: "1u7vNdo7mwrdKEYKE0mosq",
        deezerId: "416401237",
        designers: [],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "quicksilver_messenger_service_shady_grove",
        title: "Shady Grove",
        artist: "Quicksilver Messenger Service",
        year: 1969,
        country: regions.USA,
        criteria: [criteria.ROCK, criteria.C_FOLK, criteria.C_PSYCHE],
        selectedTrackTitle: "Edward, The Mad Shirt Grinder",
        selectedTrackYtId: "iJBPlmqQ2DY",
        spotifyId: "78iN3JSUuZ5RDI4SUR7j7d",
        deezerId: "73847312",
        designers: ["George Hunter"],
        similarAlbums: [],
        isAGem: false,
    ...
    {
        id: "quicksilver_messenger_service_just_for_love",
        title: "Just For Love",
        artist: "Quicksilver Messenger Service",
        year: 1970,
        country: regions.USA,
        criteria: [criteria.UNCOMMON_INSTRUMENTS, criteria.ROCK, criteria.C_FOLK],
        selectedTrackTitle: "The Hat",
        selectedTrackYtId: "Xpwirz5KjRI",
        spotifyId: "0jebR4BSBCxMAXezJcDC1m",
        deezerId: "73845602",
        designers: ["Mike Cantrell"],
        similarAlbums: [],
        isAGem: false,
    },
    {
