...
const albums = [
    ...
    },
    {
        ...
        year: 1979,
        country: regions.ENGLAND,
        criteria: [criteria.ART_POP, criteria.C_ELECTRO, criteria.SOFT_SEVENTIES, criteria.UNCOMMON_INSTRUMENTS],
        selectedTrackTitle: "The Other Side Of Life",
        selectedTrackYtId: "eyHiP3U1n8U",
        spotifyId: "5KUNMuwPrKcWkiELM80qKT",
        deezerId: "1455498",
        designers: [],
        similarAlbums: ["roxy_music_manifesto"],
        isAGem: false,
    },
    {
        id: "japan_gentlemen_take_polaroids",
        title: "Gentlemen Take Polaroids",
        artist: "Japan",
        year: 1980,
        country: regions.ENGLAND,
        criteria: [criteria.ART_POP, criteria.C_ELECTRO, criteria.SOFT_SEVENTIES],
        selectedTrackTitle: "Burning Bridges",
        selectedTrackYtId: "wx26pjoUrm4",
        spotifyId: "0RhywRDYdXYC5Qzk0iIprW",
        deezerId: "302609",
        designers: ["Stuart McLeod"],
        similarAlbums: [],
        isAGem: false,
    },
    {
        ...
        year: 1981,
        country: regions.ENGLAND,
        criteria: [criteria.ART_POP, criteria.C_ELECTRO, criteria.SOFT, criteria.UNCOMMON_INSTRUMENTS, criteria.NEO_EIGHTIES],
        selectedTrackTitle: "Ghosts",
        selectedTrackYtId: "wOW4-oWnDPw",
        spotifyId: "71R4tl3qYgZVvdlwE7Fxs6",
        deezerId: "302610",
        designers: ["David Sylvian", "Steve Joule", "Fin Costello"],
        similarAlbums: [],
        isAGem: false,
    },
    {
    ...
    {
        id: "jeff_simmons_lucille_has_messed_my_mind_up",
        title: "Lucille Has Messed My Mind Up",
        artist: "Jeff Simmons",
        year: 1969,
        country: regions.USA,
        criteria: [criteria.BLUESY, criteria.C_PSYCHE, criteria.ROCK],
        selectedTrackTitle: "Appian Way",
        selectedTrackYtId: "3gS5XV3Zqos",
        spotifyId: "5ln2qNld7Fc3ILi0NTUEzV",
        deezerId: "339816",
