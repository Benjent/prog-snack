...
const subgenres = [
    {
        ...
        albums: ["cymande_promised_heights", "carlos_garnett_journey_to_enlightenment"],
        criteria: [
    ...
    },
    {
        ...
        albums: ["the_nice_ars_longa_vita_brevis", "gracious_gracious"],
        criteria: [
            criteria.TECHNICAL,
            criteria.INSTRUMENTAL,
            criteria.ODD_RHYTHM,
    ...
    },
    {
        ...
        albums: ["king_crimson_red", "alpha_ralpha_alpha_ralpha", "jade_warrior_way_of_the_sun"],
        criteria: [
            criteria.CONCEPT,
            criteria.C_JAZZ,
            criteria.C_ELECTRO,
    ...
    },
    {
        ...
        albums: ["dschinn_dschinn", "dull_knife_electric_indian", "birth_control_hoodoo_man"],
    ...
    },
    {
        ...
        albums: ["nektar_a_tab_in_the_ocean", "ozric_tentacles_strangeitude"],
        criteria: [
            criteria.SPACY,
            criteria.SCI_FI,
            criteria.ROCK,
    ...
    },
    {
        ...
        albums: ["weidorje_weidorje", "laurent_thibault_mais_on_ne_peut_pas_rever_tout_le_temps"],
        criteria: [
            criteria.ZEUHL,
            criteria.SPECTACULAR,
            criteria.ROCK_OPERA,
