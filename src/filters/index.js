...
Vue.filter('criterium', (value) => {
    const mapper = {
		...
		[criteria.C_PSYCHEDELIC]: 'Contains psychedelic elements',
		[criteria.CONCEPT]: 'Concept album',
		[criteria.CRISPY_SIXTIES]: 'Crispy 60s sound',
		[criteria.CROATIAN_SUNG]: 'Croatian sung',
		...
		[criteria.FRENCH_SUNG]: 'French sung',
		[criteria.FUNNY]: 'Funny',
		[criteria.GERMAN_SUNG]: 'German sung',
		...
		[criteria.IGBO_SUNG]: 'Igbo sung',
		[criteria.INSTRUMENTAL]: 'Mainly instrumental',
		[criteria.ITALIAN_SUNG]: 'Italian sung',
