 ...
 */
const getYouTubeUrl = (trackId) => {
    return trackId && `https://www.youtube.com/watch?v=${trackId}`
}
...
const getDeezerUrl = (albumId) => {
    return albumId && `https://widget.deezer.com/widget/dark/album/${albumId}`
}
 ...
 */
const getSpotifyUrl = (albumId) => {
    return albumId && `https://open.spotify.com/embed/album/${albumId}`
}
